...
This shared type file collects reusable primitives, function signatures, and React helpers that can be imported across components, services, and hooks.
...
- Standardizes common value and callback types across the app.
- Reduces repeated inline type declarations.
- Keeps shared utility types in one import location.
